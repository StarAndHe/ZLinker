...
const _zh = {
  ...
  'remote.monitor.waiting.title': '需要你的确认',
  'remote.monitor.waiting.body': '@桌面端正在等待你的决定（权限/批准）',
  'remote.monitor.done.title': '任务已完成',
  'remote.monitor.done.body': '任务已完成，点击查看结果',
  'phase.running': '运行中',
...
const _en = {
  ...
  'remote.monitor.waiting.title': 'Needs your decision',
  'remote.monitor.waiting.body': 'The desktop is waiting for your approval',
  'remote.monitor.done.title': 'Task completed',
  'remote.monitor.done.body': 'Task completed — tap to view the result',
  ...
  'notify.task.waiting': 'Needs your decision',
